import { loadCarruselup, loadFooter, loadNavbar, renderEvents} from "./index.js";
...
async function loadData() {
  try {
    ...
    // Clasificar en eventos presentes
    let presentEvents = [];
    ...
    // Extraer categorías únicas de eventos presentes
    const categories = [...new Set(presentEvents.map(event => event.category))];
    ...
    function filterEvents() {
      ...
      const filteredEvents = presentEvents.filter(event => {
